...
public class NioServerSocketChannel extends AbstractNioMessageChannel
    ...
    /**
     *
     * @param provider SelectorProvider.provider()
     * @return
     */
    private static ServerSocketChannel newSocket(SelectorProvider provider) {
        try {
             ...
             *
             * 使用{@link SelectorProvider}打开{@link SocketChannel}， 因此删除{@link SelectorProvider#provider()}中的条件，
             * 否则每个ServerSocketChannel.open()将调用该条件。
             *
             *  See <a href="https://github.com/netty/netty/issues/2308">#2308</a>.
             *
             *  等同于 SelectorProvider.provider().openServerSocketChannel();
             */
    ...
    protected int doReadMessages(List<Object> buf) throws Exception {
        ...
        try {
            if (ch != null) {
                ...
                // 将 NioSocketChannel 存入list: 其中 NioSocketChannel 包括: unsafe/pipeline等
